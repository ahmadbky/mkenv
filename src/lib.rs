...
//!   which was forcing you to declare a const in the first place.
//! * Conditional compilation isn't supported at field level anymore. The reason for this is that
//!   the expansion would have been way more complex, especially for the [`Iter`][7] associated type
//!   of the [`ConfigInitializer`][8] trait (whose implementation is generated by the new
...
//!   trait). In short, security is no longer a concern! 🎉
//!
